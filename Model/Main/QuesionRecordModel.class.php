...
class mainQuesionRecordModel extends basic {
    ...
    public function addData($field, $data, $user) {
        ...
        foreach ($field_array as $key => $value) {
            ...
            if ($this->vars_number <= 0) {
                ...
                $dataStatistics['question_'. $data['quesion_' . $value]]+=1;


                

                $statistics = new QuestionStatisticsModel();

                $statistics->get_info($value,$dataStatistics);               
            }
        }
